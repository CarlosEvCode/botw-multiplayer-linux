...
var translations = map[Language]map[string]string{
	LangEN: {
		...
		"notif.base_required":    "Please configure your Base Game directory first in Paths tab.",
	...
	LangES: {
		...
		"notif.base_required":    "Por favor configure primero la carpeta del Juego Base en la pestaña Rutas.",
